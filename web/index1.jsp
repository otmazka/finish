        ...
        <section class="page-banner">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12">
                        <h1>Добро пожаловать в приложение GrossBuh</h1>
                    </div>
                </div>
            </div>
        </section>
        ...
        <div class="container">
            <div class="row justify-content-center my-5">
              <div class="col-12 col-md-4 d-flex"> 
                  <a href="showLogin" class="btn btn-outline-primary btn-lg my-btn">Вход</a>
                </div>
            </div>
                 <div class="row justify-content-center my-5">
                  <div class="col-12 col-md-4 d-flex"> 
                  <a href="newCompany" class="btn btn-outline-primary btn-lg my-btn">Регистрация</a>
                </div>
                 </div>
            </div>
