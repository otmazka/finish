        ...
        <div class="container">
            <div class="row align-middle">
                ...
                <div class="col-12 col-md-9 ml-auto">
                    <h3>${info}</h3>
                    <form class="align-items-center col-md-auto" action="addAccount" method="POST">
                        Номер счёта:<input class="form-control col-md-9" type="text" name="number">
                        Название счёта:<input class="form-control col-md-9" type="text" name="title">
                        Кто выставил счёт:<input class="form-control col-md-9" type="text" name="author">
                        Год: <input class="form-control col-md-9" type="text" name="year">
                        Месяц: <input class="form-control col-md-9" type="text" name="month">
                        Итого: <input class="form-control col-md-9" type="text" name="total"><br>
