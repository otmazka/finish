            ...
            <div class="row align-middle">
                <div class="col-12 col-md-3">
                    <div class="btn-group-vertical-auto">
                        ...
                        <a href="showTakeOnAccount" class="list-group-item list-group-item-action ">Оплатить счет</a>
                ...
                <div class="col-12 col-md-9 ml-auto">
                    ...
                    <form action="takeOnAccount" method="POST">
                        <h3>Список счетов</h3> 
                        <select class="form-control col-md-9" name="accountId">
                        ...
                        <select class="form-control col-md-9" name="companyId">
